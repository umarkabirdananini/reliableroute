...
- Full company information, both Apapa offices, four telephone numbers, and email.
...
The visitor reviews their message, chooses WhatsApp or email, and sends it from that application. The main WhatsApp destination is **+234 816 046 2928** (08160462928 within Nigeria). The email destination is **reliableroutes@gmail.com**. Visitors can also copy the prepared message if their device cannot open the application or if a very long email URL is not supported by their mail client.
